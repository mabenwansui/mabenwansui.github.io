    ...
    _createClass(AlertTs, [{
      ...
      value: function setZindex() {
        ...
        var getAutoIndex = function getAutoIndex() {
          var maxindex = 0;
          _this7.element.parents().each(function () {
    ...
    if (typeof options == 'string') {
      var _ret2 = function () {
        ...
        switch (method) {
          case "getClass":
            return {
              v: $(_this8).data('plugin_' + pluginName)
            };
          default:
            return {
              v: _this8.each(function () {
