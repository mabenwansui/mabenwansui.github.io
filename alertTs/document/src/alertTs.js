  ...
  (function ($, window, undefined) {
    ...
    var AlertTs = function () {
      ...
      _createClass(AlertTs, [{
        ...
        value: function createUi() {
          ...
          var helper = $('<div class="' + className + '"></div>').css(this.options.css).data('plugin_' + pluginName, this.element);
          ...
          (function () {
            switch (_this5.options.act) {
              ...
              case 'hover':
                var _in = {},
                    _out = {},
                    _delay = _this5.options.hoverdelay,
    ...
    $[pluginName] = {
      ...
      parent: function parent(element) {
        return $(element).closest('.' + className).data("plugin_" + pluginName).data("plugin_" + pluginName);
      }
    };
  })(jQuery, window);
